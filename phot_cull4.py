...
awk '{printf "%.2f %.2f\n", $3, $4}' phot > phot.xy
awk '{printf "%.3f %.3f %.3f \n", $16, $29, $42}' phot > phot.mags
awk '{printf "%.3f %.3f %.3f \n", $18, $31, $44}' phot > phot.errs
awk '{printf "%.2f %.2f %.2f %.2f %.2f\n", $13, $26, $39, $52, $65}' phot > phot.sky
awk '{printf "%.2f %.2f %.2f %.2f\n", $19, $32, $45, $5}' phot > phot.chi
awk '{printf "%.1f %.1f %.1f %.1f \n", $20, $33, $46, $6}' phot > phot.snr
awk '{printf "%.3f %.3f %.3f %.3f \n", $21, $34, $47,  $7}' phot > phot.sharp
awk '{printf "%.3f %.3f %.3f %.3f \n", $22, $35, $48, $8}' phot > phot.round
awk '{printf "%.3f %.3f %.3f %.3f \n", $23, $36, $49, $10}' phot > phot.crowd
awk '{printf "%d %d %d %d \n", $24, $37, $50,  $11}' phot > phot.flags

mv Mixed_dwarf_full_Z_observed_WFIRST-WFI.txt Z087_stips.txt
mv Mixed_dwarf_full_Y_observed_WFIRST-WFI.txt Y106_stips.txt
mv Mixed_dwarf_full_H_observed_WFIRST-WFI.txt H158_stips.txt
